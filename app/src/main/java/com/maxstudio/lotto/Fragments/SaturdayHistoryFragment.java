...
public class SaturdayHistoryFragment extends Fragment {
    ...
    public SaturdayHistoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_saturday_history, container, false);

        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Saturday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.saturday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("National Weekly History");
        ...
        adapter1 = new TuesAdapter(getContext(),combinedDataList,
                isScrolled,indicator,LottoRef,day,isDestroyed,isLoading,indicator2);
