...
public class TuesdayHistoryFragment extends Fragment {
    ...
    private boolean isDestroyed,isScrolled,isDay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_tuesday_history, container, false);

        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Tuesday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.tuesday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("Lucky Tuesday History");
