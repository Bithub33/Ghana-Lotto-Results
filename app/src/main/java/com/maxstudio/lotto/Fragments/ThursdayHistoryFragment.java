...
public class ThursdayHistoryFragment extends Fragment {
    ...
    public ThursdayHistoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_thursday_history, container, false);

        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Thursday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.thursday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("Fortune Thursday History");
    ...
    public void onDestroyView() {
        ...
        //DataRequest2();
        isDestroyed = true;
        //InterstitialAd.load(getContext(),null,null,null);
    }
