...
public class MondayHistoryFragment extends Fragment {

    private RecyclerView ResultsRecyclerList;
    private String Lotto1,Lotto2,Lotto3,Lotto4,Lotto5,Mach1,Mach2,Mach3,Mach4,Mach5, Date,d;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_monday_history, container, false);

        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Monday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.monday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("Monday Special History");
        ...
        adapter1 = new TuesAdapter(getContext(),combinedDataList,isScrolled
                ,indicator,LottoRef,day,isDestroyed,isLoading,indicator2);
    ...
    private void nextLoad()
    {
        ...
        String d = dailyResultsPicker.getKey();

        Query query = LottoRef.orderByKey().startAfter(d).limitToFirst(20);
