...
public class SundayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Sunday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.sunday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("Sunday Aseda History");
