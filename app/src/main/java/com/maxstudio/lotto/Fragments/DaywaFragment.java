...
public class DaywaFragment extends Fragment implements Refresh {
    private View view;
    ...
    private String daywaTag = "daywa";
    private AltAdapter altAdapter;
    private ValueEventListener val,val2,val3,val4,val5,val6,val7;
    private int VIEW_TYPE_FIRST = 0;
    private ProgressBar indicator;
    private RecyclerView rec;
    private List<DailyResultsPicker> combinedDataList = new ArrayList<>();
    private final String[] com = {"Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"};

    public DaywaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_daywa, container, false);
    ...
    private void requests()
    {
        ...
        if (MainActivity.combinedDataList4.isEmpty())
        {
            DatabaseReference LottoRef = FirebaseDatabase.getInstance().getReference()
                    .child("Other Games").child("Daywa");
        ...
        {
            combinedDataList.clear();
            combinedDataList.addAll(MainActivity.combinedDataList4);
            if (altAdapter != null)
            {
                altAdapter.notifyDataSetChanged();
                //rec.requestLayout();
