...
public class WednesdayHistoryFragment extends Fragment {
    ...
    public WednesdayHistoryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View = inflater.inflate(R.layout.fragment_wednesday_history, container, false);

        LottoRef = FirebaseDatabase.getInstance().getReference()
                .child("Results History").child("Wednesday");
        ...
        ResultsRecyclerList = View.findViewById(R.id.wednesday_recycler);
        ...
        if (activity != null)
        {
            ...
            activity.getSupportActionBar().setTitle("Midweek History Results");
